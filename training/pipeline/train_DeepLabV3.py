...
def create_train_transforms(size=128):
    return A.Compose([
        ...
        A.Blur(p=0.3),
        A.ElasticTransform(alpha=0.15, p=0.2),
        A.Rotate(20, p=0.5),
...
def load_args():
    ...
    arg('--config', default="DeepLabV3")
    arg('--data', default="/github/data.csv")
    arg('--model_save', default='/github/model_result/DeepLabV3/')
    arg('--model_save_prefix', default="DeepLabV3_")
